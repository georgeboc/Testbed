...
function execute_batch () {
  ...
  PIPELINE="hdfs://dtim:27000/user/bochileanu/pipelines/big_join_pipeline-column_number-0-Ad_click_on_taobao_1g.json"
  OUTPUT="hdfs://dtim:27000/user/bochileanu/analysis_results/big_join_pipeline.xlsx"
  TIMED_SHEET_NAME="T|LB1"
  INSTRUMENTED_SHEET_NAME="I|LB1"
  bash -c "$EXPERIMENTS_RUNNER_SCRIPT_PATH '$PIPELINE' '$OUTPUT' '$TIMED_SHEET_NAME' '$INSTRUMENTED_SHEET_NAME' '5'"
    
  PIPELINE="hdfs://dtim:27000/user/bochileanu/pipelines/big_join_pipeline-column_number-1-Ad_click_on_taobao_1g.json"
  OUTPUT="hdfs://dtim:27000/user/bochileanu/analysis_results/big_join_pipeline.xlsx"
  TIMED_SHEET_NAME="T|LB2"
  INSTRUMENTED_SHEET_NAME="I|LB2"
  bash -c "$EXPERIMENTS_RUNNER_SCRIPT_PATH '$PIPELINE' '$OUTPUT' '$TIMED_SHEET_NAME' '$INSTRUMENTED_SHEET_NAME' '5'"
