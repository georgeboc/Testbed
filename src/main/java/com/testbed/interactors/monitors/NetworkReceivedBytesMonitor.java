...
public class NetworkReceivedBytesMonitor implements Monitor {
    private static final String MONITOR_NAME_PREFIX = "node";
    private static final String MONITOR_NAME_SUFFIX = "NetworkReceivedBytes";
    private static final String QUERY = "sum by(instance) (node_network_receive_bytes_total{device=~'eth.*'})";
